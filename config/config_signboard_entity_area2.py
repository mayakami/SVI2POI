...
def parse_args():
    ...
    parser.add_argument("--shopsign_json",type=str,
                        default = "/home/moss/streetview_segment/dataset/gsv_label/signboard_entity/area2/signboard_entity.json")
    parser.add_argument("--poi_json",type=str,
                        default = "poi_area2.json")
    parser.add_argument("--error_matching_dir",type=str,
                        default = "/home/moss/streetview_segment/tools/mycode/match_results/area2/error_matching")
    parser.add_argument("--merged_poi_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/area2/merged_poi.json")
    parser.add_argument("--dev_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/area2/dev.json")
    parser.add_argument("--prediction_txt",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/area2/generated_predictions.txt")
    parser.add_argument("--prediction_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/area2/merged_poi_with_name.json")
    parser.add_argument("--match_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/area2/poi_match.json")
    parser.add_argument("--mismatch_path",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/area2/poi_mismatch.txt")      
    parser.add_argument("--distance_result_dir",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/area2/distance_result")
    parser.add_argument("--match_path", type=str,
                        default="/home/moss/streetview_segment/poi_dataset/area2/poi_match.json")
    parser.add_argument("--recall_path", type=str,
                        default="/home/moss/streetview_segment/poi_dataset/area2/poi_recall.json")
    #parser for metadata
    ...
    parser.add_argument("--bbox", type=float, nargs=4,
                    default=[22.298284, 114.171652, 22.300729,114.175045],
