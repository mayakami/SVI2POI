...
def parse_args():
    ...
    parser.add_argument("--shopsign_json",type=str,
                        default = "/home/moss/github_subject/gsv_label/signboard entity/all/signboard_entity.json")
    parser.add_argument("--poi_json",type=str,
                        default = "poi.json")
    parser.add_argument("--error_matching_dir",type=str,
                        default = "/home/moss/streetview_segment/tools/mycode/match_results/all/")
    parser.add_argument("--merged_poi_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/all/merged_poi.json")
    parser.add_argument("--dev_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/all/dev.json")
    parser.add_argument("--prediction_txt",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/all/generated_predictions.txt")
    parser.add_argument("--prediction_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/all/merged_poi_with_name.json")
    parser.add_argument("--match_json",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/all/poi_match.json")
    parser.add_argument("--mismatch_path",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/all/poi_mismatch.txt")     
    parser.add_argument("--distance_result_dir",type=str,
                        default = "/home/moss/streetview_segment/poi_dataset/all/distance_result")
    parser.add_argument("--match_threshold",type=str,
                    default = 0.2)
    parser.add_argument("--lambda1",type=str,
                default = 0.2123)
